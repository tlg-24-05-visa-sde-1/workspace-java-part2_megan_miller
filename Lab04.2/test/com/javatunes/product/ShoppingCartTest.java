...
public class ShoppingCartTest {
    ...
    public void testMusicItemCart() {
        ShoppingCart<MusicItem> cart = new ShoppingCart<>();  // T is MusicItem (MusicItem IS-A Product)
    ...
    public void testMediaPlayerCart() {
        ShoppingCart<MediaPlayer> cart = new ShoppingCart<>();  // T is MediaPlayer (MediaPlayer IS-A Product)
